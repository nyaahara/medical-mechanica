...
(function() {
  window.image_path = function(name) {
    return {
      "social19.png": "/assets/social19.png",
      "back.jpg": "/assets/back.jpg",
      "smartphone.png": "/assets/smartphone.png",
      "front.jpg": "/assets/front.jpg",
      "edit10.png": "/assets/edit10.png",
      "paper64.png": "/assets/paper64.png",
      "physical.png": "/assets/physical.png",
      "hospital11.png": "/assets/hospital11.png"
    }[name];
  };
...
(function() {
  var clear_all_over, draw_all_over, draw_part_icon;

  $(function() {
    var field, part_detail, _i, _len, _ref;
    $("canvas.all-over").on('click', function(e) {
      var canvas, pageX, pageY, x, y;
      e.preventDefault;
      canvas = $(e.target);
      ...
      $('#modal-y')[0].value = y;
      $('#modalAdd').modal('show');
      return $('#modal-memo')[0].focus();
    });
    $('#modalAdd').on('shown.bs.modal', function(e) {
      return $('#modal-memo')[0].focus();
    });
    $('#add-progress').on('click', function(e) {
      $('#modalAdd').modal('hide');
      return $("#form-add a")[0].click();
    });
    $(document).on('nested:fieldAdded', function(e) {
      ...
      return draw_part_icon(part_detail);
    });
    $(document).on('nested:fieldRemoved', function(e) {
      return clear_all_over($(e.target));
    });
    _ref = $(".fields");
    ...
    $('#comment').on('shown.bs.modal', function(e) {
      return $('.modal-comment')[0].focus();
    });
    return $('#recover_completely').on('shown.bs.modal', function(e) {
      return $('#sick_recover_completely_comment')[0].focus();
    });
  });

  draw_all_over = function(part_detail) {
    var canvas, ctx, pointX, pointY;
    ...
    return ctx.fillRect(pointX, pointY, 4, 4);
  };

  clear_all_over = function(part_detail) {
    var canvas, ctx, pointX, pointY;
    canvas = $("#" + (part_detail.find('.frontOrBack')[0].value))[0];
    ctx = canvas.getContext('2d');
    pointX = part_detail.find(".pointX")[0].value;
    pointY = part_detail.find(".pointY")[0].value;
    return ctx.clearRect(pointX, pointY, 4, 4);
  };

  draw_part_icon = function(part_detail) {
    var background, canvas, ctx, draw_icon_left, draw_icon_top, half_of_canvas_height, half_of_canvas_width, pointX, pointY;
    ...
    ctx = canvas.getContext('2d');
    return ctx.fillRect(half_of_canvas_width, half_of_canvas_height, 4, 4);
  };
